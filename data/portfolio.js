...
export const PORTFOLIO = [
  ...
  { slug: "horse-run", name: "Horse Run: Running Game", confidential: false, flagship: false, category: "casual-games", platform: "Android, iOS", dim: "3D", genres: ["Endless", "Casual"], link: "https://play.google.com/store/apps/details?id=com.W1ldCraft11Anima111", stack: ["Unity", "C#"], tools: ["AdMob", "Firebase"], results: "21,000+ downloads (fake)" },
  ...
  { slug: "bank-heist", name: "Bank Heist: Robbery Escape", confidential: false, flagship: false, category: "casual-games", platform: "iOS", dim: "3D", genres: ["Action", "Hyper Casual"], link: "https://apps.apple.com/us/app/bank-heist-robbery-escape/id6746856663", stack: ["Unity", "C#"], tools: ["AdMob", "Firebase"], results: "7,300+ downloads (fake)" },
